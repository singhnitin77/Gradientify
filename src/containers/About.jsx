    ...
    <>
      ...
      <div className="px-[30px] md:px-[72px] lg:px-[80px] py-[72px] md:py-[80px] lg:py-[92px] w-full bg-[#ECF2F5]">
        <div className="lg:w-[50%] mx-auto w-full">
          ...
          <p className="text-left text-[16px] md:text-[18px] font-Epilogue font-medium mt-[42px]">
          ...
          <p className="text-left text-[16px] md:text-[18px] font-Epilogue font-medium mt-[42px] mb-[92px]">
